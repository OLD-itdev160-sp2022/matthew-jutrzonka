/**
 * Wrap everything in and IIFE (Immediately Invoked Function Expression) to keep
 * our variable constrained to the scope of this function and out of the global scope.
 */
(function() {
    ...
    var data = [
        {
            name: 'emmet',
            description: 'Emmet is the number one code snippit tool.',
            author: 'emmetio',
